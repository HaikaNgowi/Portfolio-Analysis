#Inheritance - class Child (specialized version of another class, adopts methods and attributes)
class Car:
...
class ElectricCar(Car):
	...
	def __init__(self, make, model, year):
		...
		"""define attribute specific to an electric car."""
	...
	def fill_gas_tank(self):
		...
		"""Electric cars dont have/use gas."""
